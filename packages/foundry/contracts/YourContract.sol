...
contract YourContract {
    ...
    struct CaseReport {
        ...
        uint timestampFiled;      // The block.timestamp when filed
        uint timestampLastUpdate; // The timestamp of the last update
     ...
     */
    event CaseUpdated(uint indexed caseId, CaseStatus newStatus, string updateMessage);
     ...
     */
    function acknowledgeCase(uint _caseId, string memory _updateMessage) public onlyPolice {
     ...
     */
    function addProgressUpdate(uint _caseId, string memory _updateMessage) public onlyPolice {
        CaseReport storage _case = cases[_caseId];
     ...
     */
    function closeCase(uint _caseId, string memory _finalReport) public onlyPolice {
        CaseReport storage _case = cases[_caseId];
     ...
     */
    function verifyClosure(uint _caseId, string memory _verificationMessage) public onlyJudicial {
        CaseReport storage _case = cases[_caseId];
    ...
    function getCaseDetails(uint _caseId) public view returns (CaseReport memory) {
